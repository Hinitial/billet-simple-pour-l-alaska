  ...
  <table class="table table-admin mb-5">
    ...
    <tbody class="">
      ...
      <tr scope="row">
        ...
        <td class="text-center"><a href="index.php?section=adminCommentaireEdit&id=<?php echo $enter['id_commentaire']; ?>">Modérer</a> | <a class="text-danger" href="index.php?section=adminCommentaireEdit&action=supprimer&id=<?php echo $enter['id_commentaire']; ?>">Supprimer</a></td>
      </tr>
